...
function BenefitSection({ benefit, index, reversed, state }) {
  ...
  return (
    <section className={cls + " sec-fade-top"} style={{
      padding: '100px 0',
      background: bg,
      position: 'relative',
    }}>
...
function BenefitVisual({ benefit, reversed }) {
  ...
  if (benefit.proofKind === 'memory') {
    return (
      <div className={"cw-window cw-window--lit " + spot} style={{ padding: '26px 28px' }}>
  ...
  return (
    <div className={"cw-window cw-window--lit " + spot} style={{

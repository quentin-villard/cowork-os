  ...
  return {
    ...
    main: (
      <span style={{ display: 'block' }}>
        ...
        <span style={{ display: 'block', whiteSpace: 'nowrap' }}>
          into your <em className="ital serif">personal AI assistant</em>
        </span>
      </span>
    ),
...
function Nav() {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 22, fontSize: 14, color: 'var(--ink-2)' }}>
...
function Hero({ state }) {
  ...
  return (
    <section id="hero" className={cls} style={{ paddingTop: 28, paddingBottom: 0, position: 'relative' }}>
